...
function Filter() {
    ...
    return (
        <div style={{ background: 'linear-gradient(rgb(112, 16, 19), rgb(92, 12, 18), rgb(72, 9, 15), rgb(53, 7, 9), rgb(37, 0, 0))' }} className=' min-h-screen w-full lg:px-[5%] space-y-5'>
            ...
            <div className="flex gap-5 flex-wrap px-3 lg:px-0">
                {
                    ads.map(e => 
                        ...
                        e.visibility === true && e.vacation === false && <None adsTitle={e.adsTitle} age={e.age} introduction={e.intro} profilePhoto={e.profilePhoto} id={e.id} />)
                }
            </div>
            {showFilter &&  <>
                <MobileFilter />
